...
# Recovered with an unterminated string here, so this script has never run.
# The closing quote is restored to match its siblings, which write the
# SavedModel to ~/train/ipcams-classifier; the -a10 suffix is as found.
OUT  = os.path.expanduser('~/train/ipcams-classifier-a10')
